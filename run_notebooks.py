...
def run_notebook(notebook_path):
    """
    Execute a Jupyter Notebook and return its status (Success or Error).
    """
    try:
        ...
        return False, str(e)  # Handle other errors

def run_all_notebooks(directory):
    """
    Run all Jupyter Notebooks in a given directory and collect those that fail.
    """
    error_notebooks = []
...
if __name__ == "__main__":
    ...
    # Run all notebooks in the directory
    failed_notebooks = run_all_notebooks(notebook_dir)
